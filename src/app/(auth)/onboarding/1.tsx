  ...
  return (
    ...
    >
      ...
      <View className="flex-1 justify-center items-center max-w-md mx-auto w-full">
        ...
        >
          <View className="absolute top-0 left-0 w-24 h-24 rounded-full bg-primary/5 -translate-x-6 -translate-y-6" />
          <View className="absolute bottom-0 right-0 w-32 h-32 rounded-full bg-secondary/10 translate-x-12 translate-y-12" />
          <Sparkles size={84} color="#FFD166" />
        </FadeInDownView>
