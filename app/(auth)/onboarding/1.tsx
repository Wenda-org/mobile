        ...
        <View className="flex-1 justify-center items-center">
          ...
          <View className="mb-12">
            <View className={`w-72 h-72 rounded-full items-center justify-center ${
              ...
              <View className="w-56 h-56 rounded-full bg-secondary/20 items-center justify-center">
                <View className="w-40 h-40 rounded-full bg-secondary/30 items-center justify-center">
                  <Ionicons name="sparkles" size={100} color="#FFD166" />
                </View>
              </View>
            </View>
          </View>
          ...
          <Text className={`text-lg text-center px-8 leading-7 ${isDark ? 'text-text-dark-secondary' : 'text-text-light-secondary'}`}>
            Receba sugestões inteligentes baseadas nas suas preferências e descubra lugares perfeitos para você
          </Text>
        </View>
